...
class DrawableFloorTest(unittest.TestCase):
   ...
   def test_associate_text_to_rooms(self):
      ...
      t1 = DrawableText("Text room 1",DrawablePoint(5,5))
      t2 = DrawableText("Text room 2",DrawablePoint(15,8))
      t3 = DrawableText("Text outside",DrawablePoint(11,5))
   ...
   def test_associate_text_to_rooms2(self):
      ...
      t1_1     = DrawableText("Text room 1",DrawablePoint(2,2))
      t1_2     = DrawableText("Text room 1",DrawablePoint(8,8))
      t2_1     = DrawableText("Text room 2",DrawablePoint(7,2))
      t2_2     = DrawableText("Text room 2",DrawablePoint(11,8))
      t_none   = DrawableText("Text none",DrawablePoint(5,12))
